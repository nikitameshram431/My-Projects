...
btnClear= Button(calc,text=chr(67) + chr(69),width=6,height=2,font=('arial',20,'bold'),bd=4,bg="powder blue"
                     , command=added_value.all_Clear_Entry).grid(row=1, column=1,pady=1)
btnSq= Button(calc,text="^2",width=6,height=2,font=('arial',20,'bold'),bd=4,bg="powder blue"
...
btnPi= Button(calc,text="n",width=6,height=2,font=('arial',20,'bold'),bd=4,bg="powder blue",
...
btn2Pi= Button(calc,text="2n",width=6,height=2,font=('arial',20,'bold'),bd=4,bg="powder blue",
...
btnalog1p= Button(calc,text="log1p",width=6,height=2,font=('arial',20,'bold'),bd=4,bg="powder blue"
